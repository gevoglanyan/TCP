...
const faqs = [
  ...
  { q: 'Do you handle TCP renewals?', a: 'Yes. We manage the full TCP renewal process so your permit stays active and in good standing. Contact us before your renewal deadline to avoid any lapse in operating authority.' },
  { q: 'Can you transfer a TCP to a new owner?', a: 'Yes. TCP transfers involve a separate CPUC process. We handle all the paperwork and coordination required to transfer an existing permit to a new business entity or owner.' },
  { q: 'Do you help with airport permits?', a: 'Yes. We assist with obtaining and renewing airport operating permits required to pick up and drop off passengers at California airports. Requirements vary by airport so contact us with your specific location.' },
  { q: 'What is an EIN and do I need one?', a: 'An Employer Identification Number (EIN) is issued by the IRS and is required for your business to open a bank account, hire employees, and file taxes. We handle the IRS application on your behalf — it\'s typically one of the first steps after forming your corporation.' },
  { q: 'Do you help form corporations or LLCs?', a: 'Yes. We file your Articles of Incorporation or Articles of Organization with the California Secretary of State. Having a registered business entity is required before any TCP or permit application can begin.' },
  { q: 'What is quarterly or yearly filing?', a: 'Certain CPUC and city requirements involve ongoing periodic filings to keep your operating authority current. We handle both quarterly and yearly filings so you stay compliant without having to track deadlines yourself.' },
];
    ...
    >
      ...
      >
        <span className={`text-sm font-semibold leading-snug tracking-tight transition-colors duration-200 ${
          isOpen ? 'text-[#E8D5A3]' : 'text-[#F0EDE8] group-hover:text-[#E8D5A3]'
        }`}>
          {faq.q}
        </span>
        <motion.div
      ...
      <div className="max-w-6xl mx-auto" ref={ref}>
        <div className="grid md:grid-cols-[300px_1fr] gap-12 md:gap-20 items-start">
          <div className="md:sticky md:top-28">
            ...
            >
              Can't find your answer? Reach out directly and we'll walk you through your specific situation.
            </motion.p>
            <motion.a
              initial={{ opacity: 0 }}
              animate={inView ? { opacity: 1 } : {}}
