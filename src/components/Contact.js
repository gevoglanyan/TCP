...
const inputClass = "bg-[#0C0C0C] border border-[#2A2A2A] focus:border-[#E8D5A3] rounded-xl px-4 py-3 text-sm text-[#F0EDE8] outline-none transition-colors duration-200 placeholder-[#3A3A3A] w-full appearance-none";
          ...
          <div className="md:sticky md:top-28">
            ...
            >
              {[
                ...
                { label: 'Hours', val: 'Mon–Fri, 9am–6pm PT' },
              ].map((c) => (
                <div key={c.label} className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[0.58rem] font-mono font-semibold uppercase tracking-widest text-[#888888]/60">{c.label}</div>
                    <div className="text-sm font-medium text-[#F0EDE8]">{c.val}</div>
                  </div>
                </div>
              ))}
            </motion.div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" placeholder="Smith" required className={inputClass} />
              </div>
            </div>
            ...
            <div>
              ...
              <select className={inputClass} style={{ paddingRight: '2.2rem' }}>
                ...
                <optgroup label="TCP Permits">
                  <option>Standard TCP ($1,000 Filing Fee)</option>
                  <option>Class A Certificate ($1,500 Filing Fee)</option>
                </optgroup>
                <optgroup label="TCP Services">
                  <option>TCP Renewal</option>
                  <option>TCP Transfer</option>
                </optgroup>
                <optgroup label="Filing">
                  <option>Quarterly Filing</option>
                  <option>Yearly Filing</option>
                </optgroup>
                <optgroup label="Business Services">
                  <option>Corporation Formation</option>
                  <option>EIN Number</option>
                </optgroup>
                <optgroup label="Permits">
                  <option>City Permit</option>
                  <option>Airport Permit</option>
                  <option>Airport Permit Renewal</option>
                </optgroup>
            ...
            <div>
              ...
              <select className={inputClass} style={{ paddingRight: '2.2rem' }}>
                ...
                <option>Bus (25+ Passengers)</option>
            ...
            <div>
              ...
              <textarea
                rows={4}
                placeholder="Describe your planned service, number of vehicles, existing registrations, or anything else we should know..."
            ...
            <button
              ...
              className={`w-full py-4 px-6 rounded-2xl font-bold text-sm border-none cursor-pointer transition-all duration-300 ${
                status === 'done'
                  ? 'bg-[#4ADE80]/15 text-[#4ADE80] cursor-default'
                  : status === 'loading'
                  ? 'bg-[#E8D5A3]/50 text-[#0C0C0C] cursor-wait'
